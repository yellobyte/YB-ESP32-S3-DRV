...
![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/Driver-ICs_compared.jpg)

Furthermore the board provides **two JST XH connectors** that match exactly the 5-wire connector of a common 5V/12V [**28BYJ-48 stepper motor**](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/28BYJ-48-Stepper-Motor-Spec.pdf). This lets you easily plug two such motors into the board without the need for any extra wiring between board and steppers.

In addition, the board features **eight channel LEDs** (connected to X1...X4 and Y1...Y4) that indicate [channel activity](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_board_with_two_5V-steppers.mp4) and therefore provides a clear visual feedback as motors step or solenoids and other connected devices get activated. If you prefer them to stay dark then solder bridges LEDX/LEDY must be opened.

![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_board_with_two_5V-steppers.jpg)
...
## YB-ESP32-S3-DRV board features in detail:
 ...
 - **Toshiba TBD62083A** driver IC, an 8-channel sink type DMOS transistor array with integrated suppression diodes for inductive load driving. Each channel is rated at 500mA max. output current resp. 50V max. output voltage. Outputs can be paralleled for higher current. This driver chip is similar to the commonly used ULN2803 but offers reduced forward voltage Vf at each output (when on) by using a DMOS MOSFET transistor instead of darlingtons. The chip is connected to the ESP32-S3 as follows:
   ...
   - *GPIO4...GPIO7* - for driving pins Y1...Y4 (additionally routed to 'Y' socket)
    ...
    Please note: The maximal power dissipation Pd of the chip must not exceed 0.96W at any time. If needed, a heat sink can be mounted on the chip. Folder [doc](https://github.com/yellobyte/YB-ESP32-S3-DRV/tree/main/doc) holds the driver IC's spec sheet.
...
![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_modules_replacement.jpg)

## Board Pin Layout:
![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_pinlayout.jpg)  

The boards **pin layout**, **outline** and **schematic** files are all located in folder [doc](https://github.com/yellobyte/YB-ESP32-S3-DRV/tree/main/doc).
...
![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_recommended_wiring.jpg)  
...
![](https://github.com/yellobyte/YB-ESP32-S3-DRV/raw/main/doc/YB-ESP32-S3-DRV_PlatformIO_board_selection.jpg)
...
2) The board supports USB Serial JTAG debugging. An example is provided [here](https://github.com/yellobyte/YB-ESP32-S3-DRV/tree/main/examples/PlatformIO/Debug-via-builtin-JTAG). 
